...
void Bluemary::init()
{
	...
	mData.AnimSpeed.insert(pair<ChAnimData::AnimStatus, int>(ChAnimData::AnimStatus::Move_Front, 6));
	mData.AnimSpeed.insert(pair<ChAnimData::AnimStatus, int>(ChAnimData::AnimStatus::Move_Backward, 8));
