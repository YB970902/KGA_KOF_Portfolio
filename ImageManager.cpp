...
void ImageManager::init()
{
	...
	mimageList[eImageTag::LeonaLeftBackward]->Init("Image/Leona_Database_IMG/Leona_Walk_Back.bmp", 640, 140, 8, 1, true, RGB(255, 0, 255));
	...
	mimageList[eImageTag::LeonaRightIdle]->Init("Image/Leona_Database_IMG/Leona_Idle.bmp", 3680, 120, 46, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightForward]->Init("Image/Leona_Database_IMG/Leona_Walk_Front.bmp", 800, 120, 10, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightBackward]->Init("Image/Leona_Database_IMG/Leona_Walk_Back.bmp", 640, 140, 8, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightDamaged]->Init("Image/Leona_Database_IMG/Leona_Damaged.bmp", 300, 120, 3, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightDead]->Init("Image/Leona_Database_IMG/Leona_Dead.bmp", 2480, 190, 20, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightWeakPunch]->Init("Image/Leona_Database_IMG/Leona_Weak_Punch.bmp", 1400, 140, 5, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightWeakKick]->Init("Image/Leona_Database_IMG/Leona_Weak_Kick.bmp", 2240, 140, 8, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightStrongPunch]->Init("Image/Leona_Database_IMG/Leona_Strong_Punch.bmp", 3080, 140, 11, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightStrongKick]->Init("Image/Leona_Database_IMG/Leona_Strong_Kick.bmp", 3920, 140, 14, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightNearWeakPunch]->Init("Image/Leona_Database_IMG/Leona_Near_Weak_Punch.bmp", 680, 170, 4, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightNearWeakKick]->Init("Image/Leona_Database_IMG/Leona_Near_Weak_Kick.bmp", 850, 170, 5, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightNearStrongPunch]->Init("Image/Leona_Database_IMG/Leona_Near_Strong_Punch.bmp", 2040, 170, 12, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::LeonaRightNearStrongKick]->Init("Image/Leona_Database_IMG/Leona_Near_Strong_Kick.bmp", 1530, 170, 9, 1, true, RGB(255, 0, 255),1);
	...
	mimageList[eImageTag::RalfLeftStrongPunch]->Init("Image/Ralf_Database_IMG/Ralf_Strong_Punch.bmp", 1680, 140, 8, 1, true, RGB(255, 0, 255));
	...
	mimageList[eImageTag::RalfLeftNearWeakPunch]->Init("Image/Ralf_Database_IMG/Ralf_Weak_Punch.bmp", 488, 120, 4, 1, true, RGB(255, 0, 255));
	...
	mimageList[eImageTag::RalfRightIdle]->Init("Image/Ralf_Database_IMG/Ralf_Idle.bmp", 2345, 120, 35, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightForward]->Init("Image/Ralf_Database_IMG/Ralf_Walk_Cycle.bmp", 528, 120, 8, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightBackward]->Init("Image/Ralf_Database_IMG/Ralf_Walk_Cycle.bmp", 528, 120, 8, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightDamaged]->Init("Image/Ralf_Database_IMG/Ralf_Damaged.bmp", 568, 120, 4, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightDead]->Init("Image/Ralf_Database_IMG/Ralf_Dead.bmp", 2850, 190, 19, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightWeakPunch]->Init("Image/Ralf_Database_IMG/Ralf_Weak_Punch.bmp", 488, 120, 4, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightWeakKick]->Init("Image/Ralf_Database_IMG/Ralf_Weak_Kick.bmp", 768, 120, 6, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightStrongPunch]->Init("Image/Ralf_Database_IMG/Ralf_Strong_Punch.bmp", 1680, 140, 8, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightStrongKick]->Init("Image/Ralf_Database_IMG/Ralf_Strong_Kick.bmp", 2352, 120, 12, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightNearWeakPunch]->Init("Image/Ralf_Database_IMG/Ralf_Weak_Punch.bmp", 488, 120, 4, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightNearWeakKick]->Init("Image/Ralf_Database_IMG/Ralf_Near_Weak_Kick.bmp", 600, 130, 4, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightNearStrongPunch]->Init("Image/Ralf_Database_IMG/Ralf_Near_Strong_Punch.bmp", 2100, 130, 14, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::RalfRightNearStrongKick]->Init("Image/Ralf_Database_IMG/Ralf_Near_Strong_Kick.bmp", 1200, 130, 8, 1, true, RGB(255, 0, 255),1);
	...
	mimageList[eImageTag::BluemaryLeftNearStrongPunch]->Init("Image/Bluemary_Database_IMG/Bluemary_Near_Strong_Punch.bmp", 1800, 140, 15, 1, true, RGB(255, 0, 255));
	mimageList[eImageTag::BluemaryLeftNearStrongKick]->Init("Image/Bluemary_Database_IMG/Bluemary_Near_Strong_Kick.bmp", 1300, 150, 13, 1, true, RGB(255, 0, 255));
	...
	mimageList[eImageTag::BluemaryRightIdle]->Init("Image/Bluemary_Database_IMG/Bluemary_Idle.bmp", 720, 100, 12, 1, true, RGB(255, 0, 255),1);
	...
	mimageList[eImageTag::BluemaryRightStrongKick]->Init("Image/Bluemary_Database_IMG/Bluemary_Strong_Kick.bmp", 2160, 130, 12, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::BluemaryRightNearWeakPunch]->Init("Image/Bluemary_Database_IMG/Bluemary_Near_Weak_Punch.bmp", 300, 104, 5, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::BluemaryRightNearWeakKick]->Init("Image/Bluemary_Database_IMG/Bluemary_Near_Weak_Kick.bmp", 490, 130, 7, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::BluemaryRightNearStrongPunch]->Init("Image/Bluemary_Database_IMG/Bluemary_Near_Strong_Punch.bmp", 1800, 140, 15, 1, true, RGB(255, 0, 255),1);
	mimageList[eImageTag::BluemaryRightNearStrongKick]->Init("Image/Bluemary_Database_IMG/Bluemary_Near_Strong_Kick.bmp", 1300, 150, 13, 1, true, RGB(255, 0, 255),1);
}

Image* ImageManager::GetImage(eImageTag eimageTag)
{
	return mimageList[eimageTag];
}