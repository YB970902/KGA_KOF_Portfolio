...
enum class eSceneTag { OpeningScene,CharacterSelectScene, HitBoxSnene, AnimationScene, EndingScene};
enum class eCharacterType { Null, Bluemary, Ralf, Leona, };

extern HWND g_hWnd;
extern HINSTANCE g_hInstance;

extern int g_Player1;
extern int g_Player2;
extern bool g_bWinner;
